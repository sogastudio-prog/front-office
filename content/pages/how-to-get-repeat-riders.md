...
summary: Drivers get repeat riders by giving great service, recognizing future-ride moments, and giving passengers a simple way to book them directly again.
audience: Uber and Lyft drivers
primary_topic: getting repeat riders as an independent driver
cta: request-access
schema_type: Article
...
The opportunity is already happening inside the car. The problem is that most drivers do not have a system for turning a good ride into a future ride.
...
SoloDrive gives drivers the infrastructure to accept direct ride requests under their own name.
...
SoloDrive is built around this idea:
