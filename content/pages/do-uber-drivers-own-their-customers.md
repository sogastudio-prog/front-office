...
summary: Uber drivers usually do not own their customers because the app controls the rider relationship. Drivers can start building ownership by creating a direct booking path for repeat riders.
audience: Uber and Lyft drivers
primary_topic: customer ownership for rideshare drivers
cta: request-access
schema_type: Article
last_reviewed: 2026-04-28
---

Uber drivers usually do not own their customers because the app controls the rider relationship.

The driver provides the service, but the passenger relationship stays with the platform. That is why the same driver can give a great ride and still have no reliable way to serve that rider again.
...
SoloDrive gives drivers the infrastructure to create direct rider relationships.
...
SoloDrive supports the idea that:
